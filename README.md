Ich verstehe, dass du es einfach kopieren und einfügen möchtest, ohne die Formatierungsprobleme. Hier ist der Inhalt der `README.md` als einfacher Text, der direkt in GitHub funktioniert.
