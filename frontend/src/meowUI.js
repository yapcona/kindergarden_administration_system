    ...
    <div className="god-container" style={{ position: "relative" }}>
      ...
      <div className="box-row">
        <button
          ...
          style={{
            backgroundColor: "#adebaaff",
            backgroundImage: `url(${"/pictures/sun.png"})`,
            backgroundSize: "45%",
            backgroundPosition: "47px -3px",
            backgroundRepeat: "no-repeat",
          }}
          onClick={() => navigate("/manage/sonnenstrahl")}
        >
          <h2 id="sonnenstrahl" className="box-title">
            Sonnenstrahl{" "}
          </h2>
        ...
        <button
          ...
          style={{
            backgroundColor: "#adebaaff",
            backgroundImage: `url(${"/pictures/rainbow.png"})`,
            backgroundSize: "100%",
        ...
        >
          <h2 id="regenbogen" className="box-title">
            Regenbogen{" "}
          </h2>
          <h2 style={{ fontSize: "30px" }}> </h2>
        </button>
        ...
        >
          <h2 id="addLocation" className="box-title">
            {" "}
          </h2>
        </button>
      </div>
